...
with open(output_file, "w", newline="") as datafile:
    ...
    datafile.write("\n")
    datafile.write('Total Votes: ' + str(totalVotes))
    datafile.write("\n")
    datafile.write(breaker)
    datafile.write("\n")
    datafile.write('Khan: ' + percentKhan + '% (' + str(Khan) + ')')
    datafile.write("\n")
    datafile.write('Correy: ' + percentCorrey + '% (' + str(Correy) + ')')
    datafile.write("\n")
    datafile.write('Li: ' + percentLi + '% (' + str(Li) + ')')
    datafile.write("\n")
    datafile.write('O\'Tooley: ' + percentOTooley + '% (' + str(OTooley) + ')')
    datafile.write("\n")
    datafile.write(breaker)
    datafile.write("\n")
